...
const modules = [
    ...
    { id: 'investigation', title: "Workplace Investigation Manager", summary: "Protocols for harassment and discrimination claims.", IconComponent: Search },
                        ...
                        <div className="p-6">
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0">
                                    <module.IconComponent className="h-10 w-10 text-gold" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-gold leading-tight group-hover:underline">{module.title}</h3>
